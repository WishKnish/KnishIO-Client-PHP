...
/*
	Vendored into KnishIO-Client-PHP from desktopd/php-sha3-streamable
	(github.com/evias/PHP-SHA3-Streamable @ b099bb81050c71eef7f42d46d287086a4949b861),
	re-namespaced, with the PHP 8.2+ blockSize property declared. The upstream
	LGPL-3+ license above continues to apply to this file; see THIRD-PARTY-LICENSES.md.
*/


namespace WishKnish\KnishIO\Client\Libraries\Crypto\SHA3;
use Error;
use Exception;
...
class Sponge {
	...
	*/
	...
	private $blockSize = 0; // declared for PHP 8.2+ (dynamic properties deprecated)
