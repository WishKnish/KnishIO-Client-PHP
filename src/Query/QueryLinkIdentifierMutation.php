...
{
	// Query
	protected static $query = 'mutation( $bundle: String!, $type: String!, $content: String! ) { LinkIdentifier( bundle: $bundle, type: $type, content: $content ) { type, bundle, type, content, set, message } }';
